...
- (instancetype)initWithVideoDuration:(CMTime)duration {
    ...
    if (self) {
        ...
        [self.clearButton setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_edit_delete")] forState:(UIControlStateNormal)];
        ...
        [self.cancelButton setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_revocation")] forState:(UIControlStateNormal)];
        ...
        [self.cancelButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.mas_equalTo(self.clearButton.mas_right).offset(12);
        }];
        ...
        [self.widthView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.height.mas_equalTo(5.f);
        }];
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    if (self.colorSource.count > indexPath.item) {
        ...
        if (self.currentColor == cellColor) {
            ...
            colorView.layer.borderColor = QN_RGBCOLOR(6.0, 130.0, 255.0).CGColor;
        } else {
