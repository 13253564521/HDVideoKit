...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImage *panImage = [UIImage imageNamed:HDBundleImage(@"paishe/qn_video_pan")];
...
- (void)initBorder{
    ...
    self.positionLineView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:HDBundleImage(@"paishe/qn_btn_cut_line")]];
...
//    self.endTime = CMTimeMake(10 * asset.duration.timescale, asset.duration.timescale);
