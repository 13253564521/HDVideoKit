...
- (instancetype)initWithThumbImage:(NSArray<UIImage *> *)thumbArray videoDuration:(CMTime)duration {
    ...
    if (self) {
        ...
        [self.doneButton setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_done")] forState:(UIControlStateNormal)];
...
- (void)setupPanBorder{
    ...
    self.topLineView.backgroundColor  = QN_RGBCOLOR(6.0, 130.0, 255.0);
    self.bottomLineView.backgroundColor = QN_RGBCOLOR(6.0, 130.0, 255.0);
    ...
    UIImage *panImage = [UIImage imageNamed:HDBundleImage(@"video/qn_video_pan")];
    ...
    [self.topLineView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.leftPanView.mas_right);
        make.right.mas_equalTo(self.rightPanView.mas_left);
        make.height.mas_equalTo(3);
        make.top.mas_equalTo(self.leftPanView);
    }];
    
    [self.bottomLineView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.height.mas_equalTo(self.topLineView);
        make.bottom.mas_equalTo(self.leftPanView);
    }];
