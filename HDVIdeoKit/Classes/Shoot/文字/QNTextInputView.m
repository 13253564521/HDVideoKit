...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [cancelButton setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_icon_close")] forState:(UIControlStateNormal)];
        [cancelButton addTarget:self action:@selector(clickCancelButton) forControlEvents:(UIControlEventTouchUpInside)];
        [doneButton setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_done")] forState:(UIControlStateNormal)];
