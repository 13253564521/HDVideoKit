...
- (void)setupUI{
    ...
    _dragBtn = [[QNPanImageView alloc] initWithImage:[UIImage imageNamed:HDBundleImage(@"video/qn_sticker_rotate")]];
    _dragBtn.userInteractionEnabled = YES;
    [self addSubview:_dragBtn];
    
    _closeBtn = [[UIButton alloc] init];
    [_closeBtn setImage:[UIImage imageNamed:HDBundleImage(@"video/qn_sticker_delete")] forState:UIControlStateNormal];
